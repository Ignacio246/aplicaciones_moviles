...
class RestarPage extends StatefulWidget {
  RestarPage({Key? key}) : super(key: key);

  @override
  _RestarPageState createState() => _RestarPageState();
}

class _RestarPageState extends State<RestarPage> {
    ...
    return Scaffold(
        ...
        body: ListView(
          ...
          children: <Widget>[
            ...
            Padding(
              padding: EdgeInsets.fromLTRB(50, 50, 10, 5),
              child: Text("La resta es: $_numero",),
            )
          ],
        ),
